...
public class EZFXStyleKit : NSObject {
    ...
    @objc dynamic public class func drawEZBlueKnob(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 200, height: 200), resizing: ResizingBehavior = .aspectFit, knobValue: CGFloat = 0.657, knobName: String = "KnobName") {
        ...
        let knobNameLabelFontAttributes = [
            .font: UIFont(name: "Copperplate", size: 19)!,
    ...
    @objc dynamic public class func drawEZRedKnob(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 200, height: 200), resizing: ResizingBehavior = .aspectFit, knobValue: CGFloat = 0.657, knobName: String = "KnobName") {
        ...
        let knobBGGradientColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)
        let knobBGGradientColor2 = UIColor(red: 0.377, green: 0.214, blue: 0.214, alpha: 1.000)

        //// Gradient Declarations
        let knobBGGradient = CGGradient(colorsSpace: nil, colors: [knobBGGradientColor2.cgColor, knobBGGradientColor2.blended(withFraction: 0.5, of: knobBGGradientColor).cgColor, knobBGGradientColor.cgColor] as CFArray, locations: [0, 0.69, 1])!
        ...
        context.saveGState()
        oval6Path.addClip()
        context.drawRadialGradient(knobBGGradient,
            startCenter: CGPoint(x: 100, y: 100), startRadius: 15.75,
            endCenter: CGPoint(x: 100, y: 100), endRadius: 108.68,
            options: [.drawsBeforeStartLocation, .drawsAfterEndLocation])
        context.restoreGState()
        color.setStroke()
        oval6Path.lineWidth = 4
        ...
        context.saveGState()
        ovalPath.addClip()
        context.drawLinearGradient(knobBGGradient, start: CGPoint(x: 99.5, y: 40.5), end: CGPoint(x: 99.5, y: 160.5), options: [])
        context.restoreGState()
        UIColor.white.setStroke()
        ovalPath.lineWidth = 5.5
        ovalPath.stroke()
    ...
    @objc dynamic public class func drawSelectionButton(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 77, height: 79), resizing: ResizingBehavior = .aspectFit, selectionText: String = "Distortion", selected: Bool = false) {
        ...
        let textFontAttributes = [
            .font: UIFont(name: "Copperplate", size: 10)!,
            .foregroundColor: UIColor.white,

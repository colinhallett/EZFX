...
//  EZFX
//
//  Created by Colin on 07/11/2019.
...
public class EZFXStyleKit : NSObject {
    ...
    @objc dynamic public class func drawMLKnob(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 200, height: 200), resizing: ResizingBehavior = .aspectFit, knobValue: CGFloat = 0.657, knobName: String = "KnobName") {
        ...
        let knobLineFill = UIColor(red: 0.504, green: 0.542, blue: 1.000, alpha: 1.000)
        ...
        //// Oval 4 Drawing
        let oval4Rect = CGRect(x: 8, y: 9, width: 184, height: 184)
